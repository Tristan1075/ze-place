...
const setValues = ()=>{
  ...
  return (
    <SafeAreaView >
      ...
      <Header type='back' showProfil={false}  button="Modifier" onActionTap={handleModify}></Header>
 ...
 //setValues()    
        ...
        <Header type='back' showProfil={false}  button="Valider" onActionTap={handleModify}></Header>
        <View >
